...
func run() error {
	...
	doc["x-local-api"] = M{
		...
		"rpc": M{"method": "POST", "path": "/rpc", "max_request_bytes": 65536, "max_response_bytes": 4 << 20,
			"request":   object(M{"action": M{"type": "string", "enum": []string{"init", "account-login", "account-link", "account-poll", "account-cancel", "account-logout", "account-takeover", "update-status", "update-check", "update-download", "update-cancel", "update-install", "status", "games", "rooms", "manage", "members", "create", "join", "invite", "kick", "transfer", "leave", "close", "ping", "doctor"}}, "room": str, "server": str, "name": str, "target": str, "body": M{"type": "object"}}, "action"),
			"error":     object(M{"code": str, "error": str}, "code", "error"),
			"responses": M{"update-status": ref("UpdateStatus"), "update-check": ref("UpdateStatus"), "update-download": ref("UpdateStatus"), "update-cancel": ref("UpdateStatus"), "update-install": object(M{"elevate": M{"type": "boolean"}}, "elevate"), "status": ref("Status"), "games": M{"type": "array", "items": ref("Game")}, "rooms": ref("RoomPage"), "manage": ref("RoomManagement"), "members": ref("Snapshot")}},
